...
-- 對 PRORIL_WEB 沒有 SELECT 權限會直接失敗。SerialNosJson 改由 Controller 呼叫
-- ManufacturingApiController 的內部查詢在應用層 left join 回來，見
-- api/Services/ManufacturingSerialNoLookupService.cs。
